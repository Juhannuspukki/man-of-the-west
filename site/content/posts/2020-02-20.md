...
<div class="row">
    <div class="col-md-7">
        {{< img src="sametinmaisema.jpg" caption="Rantakallioita" >}}
    </div>
    <div class="col-md-5">
        {{< img src="simpukat.jpg" caption="Siiviläsimpukoita" >}}
    </div>
</div>
...
{{< img src="rantamaisema.jpg" caption="Hotellin ranta" >}}
...
{{< img src="auringonlasku.jpg" caption="Aurinko laskee länteen" >}}
...
<div class="row">
    <div class="col-md-5">
        {{< img src="ravustaja.jpg" caption="Ravustaja rantakalliolla" >}}
    </div>
    <div class="col-md-7">
        {{< img src="ilta-aikaan.jpg" caption="Ranta illalla" >}}
    </div>
</div>
...
Kyseinen eläin on muuten todellä äänekäs. Jotta saimme nukuttua, siirsimme löytämämme sammakkoparin toiseen paikkaan.
